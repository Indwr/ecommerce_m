            ...
            <div class="invoice p-3 mb-3">
              ...
              <div class="row invoice-info">
                <div class="col-sm-4 invoice-col">
                  Company details
                  <address>
                    <strong>Deal Taukri</strong><br>
                    GSTIN No. xxxxxxx
                    <br>
                    Regd. Address: xxxxxxx<br>
                    xxxxxxxxxxx<br>
                    Contact No: +91- xxxx-xxxxxx<br>
                ...
                <div class="col-sm-4 invoice-col">
                  ...
                  <b>Invoice Date. <?php echo date('d-M-Y', strtotime($order['created_at']))?></b><br>
                ...
                <div class="col-12 table-responsive">
                  <table class="table table-striped">
                    ...
                    foreach($order_details as $key => $ord){
                      ...
                      echo'<td>'.($ord['mrp'] * $ord['quantity']).'</td>';
                      echo'</tr>';
                      $total_price = $total_price + ($ord['mrp'] * $ord['quantity']);
                ...
                <div class="col-6">
                  ...
                  <div class="table-responsive">
                    ...
                    <table class="table">
                      ...
                      <tr>
                        <th>Discount</th>
                        <td>Rs.<?php echo $total_price - $order['amount'];?></td>
                      </tr>
                      <tr>
                        <th>Coupan Discount</th>
                        <td>Rs.<?php echo $order['coupan_discount'];?></td>
                      </tr>
                      
                      <?php
                        $order_amount = $order['amount'] - $order['coupan_discount'];
...
// echo 'this is main order amount' .$order_amount . ' - ('.$order_amount.' / '.(100 + $sgst).' * 100) and tax is ' . $tax;
              ...
              <h3>Company Bank Details</h3>
                  <h3 style="font-size:18px">Deal Taukri<br>
A/C xxxxxxxxxxx<br>
IFSC CODE xxxxxxxxx<br>
xxxx BANK, xxxxx (State)</h3>
