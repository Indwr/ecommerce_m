            ...
            <div class="menu-side original">
                <h1 class="page-header">
                    <div class="btn-group pull-right follow-scroll" style="position: fixed; right:-1px; top: 120px; float:right;z-index: 9999999;">
                        ...
                        <?php echo form_open(base_url('Franchise/Shopping/checkout/'),array('method' => 'GET'));?>
                            ...
                            <div class="mainshopindia">
                                ...
                                <div class="packagesdetsils">
                                    ...
                                    <div class="row text-center">
                                        ...
                                        <input type="number" name="qty" maxlength="10" id="qty" class="input-mini lab-w ng-pristine stk" required="">
                                      </br>
                                    </div>
                                    <div class="row text-center">
                                        <!-- <a class="btn btn-default btn-clear mar-t" href="<?php echo base_url('Franchise/Shopping/checkout/?quantity[]=1&product_ids[]='.$product['id'].'&user_id='.$user['user_id']);?>">Checkout</a> -->
...
$(document).on('click','.addCart',function(){
    ...
    if(quantity > 0){
        ...
        $.get('<?php echo base_url('Franchise/Shopping/checkStock/');?>',{qnty:quantity,product:product_id},function(res){
            console.log(res);
