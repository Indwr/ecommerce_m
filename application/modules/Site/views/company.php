...
<h1 class="mt-0 mb-3 text-white">Company Profile</h1>
<div class="breadcrumbs">
<p class="mb-0 text-white"><a class="text-white" href="#">Home</a> / <span class="text-white">Company Profile</span></p>
</div>
</div>
</div>
</div>
...
<div class="col-md-12">
<?php echo $company_profile['company_profile'];?>
...
<div class="container">
	<div class="row">
		<div class="col-md-6">
			<img src="<?php echo base_url('uploads/about.jpg');?>">
		</div>
