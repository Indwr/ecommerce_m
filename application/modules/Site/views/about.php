...
<div class="container">
    <div class="row">
        <div class="pl-4 col-lg-4 col-md-5 pr-4">
            <img class="rounded img-fluid" src="<?php echo base_url('uploads/about.jpg');?>" alt="Card image cap">
        </div>
        <div class="col-lg-8 col-md-6 pl-5 pr-5">
