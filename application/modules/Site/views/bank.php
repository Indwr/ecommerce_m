...
<h1 class="mt-0 mb-3 text-white">Bank Details</h1>
<div class="breadcrumbs">
<p class="mb-0 text-white"><a class="text-white" href="#">Home</a> / <span class="text-white">Bank Details</span></p>
</div>
</div>
</div>
</div>
...
<?php echo $bankDetails['bank_details'];?>
