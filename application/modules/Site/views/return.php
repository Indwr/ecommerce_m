                            ...
                            <div class="col-12 col-md-6 columns" >
                                <div class="form-wrapper">
                                    <div class="page-header text-center">
                                        ...
                                        <h3 class="page-title">Thanks for your order placed</h3>
                                        <h3 class="page-title">Order details are below</h3>
                                        <?php
                                            if(!empty($message['referenceId'])){
                                                echo 'Order ID: '.$message['orderId'].'<br>';
                                                echo 'Amount: '.$message['orderAmount'].'<br>';
                                                echo 'Reference ID: '.$message['referenceId'].'<br>';
                                                echo 'Status: '.$message['txMsg'].'<br>';
                                                echo 'Time: '.$message['txTime'].'<br>';
                                            }
                                        ?>
                                    </div>
                                </div>
