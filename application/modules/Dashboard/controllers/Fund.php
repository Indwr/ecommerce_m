        ...
        if (is_logged_in()) {
            ...
            if ($this->input->server('REQUEST_METHOD') == 'POST') {
                ...
                if (!$this->upload->do_upload('userfile')) {
                    ...
                    $checkTraxID = $this->User_model->get_single_record('tbl_payment_request',['transaction_id' => $data['transaction_id']],'*');
                    if(empty($checkTraxID)){
                        ...
                        $this->session->set_flashdata('message', 'This Transaction ID already exists');
                    }
                }
            }
