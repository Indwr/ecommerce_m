      ...
      <div class="profile-header">
          ...
          <div class="profile-header-content" id="to-res">
              ...
              <div class="profile-header-img" id="prof_pic">
                    ...
                    if($user_bank->profile_image != ''){
                        echo'<img src="'.base_url('uploads/' . $user_bank->profile_image).'" class="img-responsive" style="max-width:100%;"><br>';
                    }else{
                        echo '<img src="https://image.shutterstock.com/image-vector/no-image-available-sign-absence-260nw-373244122.jpg" alt="user">';
                    }
                    ?>
              ...
              <div class="profile-header-info">
                  ...
                  <?php echo form_open_multipart(base_url('Dashboard/User/UploadProof/'),array('method' => 'post', 'class' => 'proofForm'));?>
                    ...
                    <input type="submit" class="btn btn-primary thgy" value="Change Picture">
          ...
          <ul class="profile-header-tab nav nav-tabs" role="tablist">
              ...
              <!-- <li class="nav-item" id="T2">
                  <a id="T22" class="nav-link" data-toggle="tab" href="#E-CURRENCY-ACCOUNT" role="tab">BANK ACCOUNT</a>
              </li> -->
              ...
              <!-- <li class="nav-item" id="T5">
                  <a id="T25" class="nav-link" data-toggle="tab" href="#KYC" role="tab">KYC VERIFICATION</a>
              </li> -->
          ...
          <div class="row row-space-20">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="value">
                                                ...
                                                <?php }else{ ?>
                                                    <input type="number" class="form-control" value="<?php echo $userinfo->phone;?>" readonly>
                                                <?php } ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="value">
                                                <?php if(empty($userinfo->postal_code)){?>
                                                    <input type="text" class="form-control" value="<?php echo $userinfo->postal_code;?>" name="postal_code">
                                                <?php }else{ ?>
                                                    <input type="text" class="form-control" value="<?php echo $userinfo->postal_code;?>" name="postal_code">
                                                <?php } ?>
                                            </td>
                                            ...
                                            <td class="value">
                                                <select class="form-control" name="city" readonly>
                                                    ...
                                                    foreach($cityArr as $k => $c){
                                                        $selected = $c['id'] == str_replace(' ','',$userinfo->city) ? 'selected' : '2';
                                            ...
                                            <td class="value">
                                                <select class="form-control" name="city" readonly>
                                                    ...
                                                    foreach($state as $k => $c){
                                                        $selected = $c['id'] == str_replace(' ','',$userinfo->state) ? 'selected' : '2';
                                                        echo'<option value="'.$c['id'].'" '.$selected.'>'.$c['name'].'</option>';
                                                    }
                                                    ?>
                                                </select>
                      ...
                      <!-- BEGIN tab-pane -->
                        <div class="tab-pane" id="E-CURRENCY-ACCOUNT">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <p class="desc"></p>
                                    <?php echo form_open_multipart(base_url('Dashboard/user/BankDetails'),array('id' =>'bankform'));?>
              ...
              <div class="col-md-4 ">
                  ...
                  <ul class="profile-info-list">
                      ...
                      echo'<hr>';
                      echo '<li class="title">SPONSER DETAIL</li>';
                      if(!empty($sponser)){
                          echo'<li>
                                    <div class="field">Name:</div>
                                    <div class="value">
                                        <span id="SpName">'.$sponser['name'].'</span>
                                    </div>
                                </li>
                                <li>
                                    <div class="field">Email-Id:</div>
                                    <div class="value">
                                        <span id="txtSpeMail">'.$sponser['email'].'</span>
                                    </div>
                                </li>
                                <li>
                                    <div class="field">Country:</div>
                                ...
                                <li>
                                    ...
                                    <div class="value">
                                        <span id="txtSpMob">'.$sponser['phone'].'</span>
                                    </div>
                                </li>';
                      }
                      ?>
