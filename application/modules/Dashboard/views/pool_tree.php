                ...
                <ul class="clearfix">
                    <li>
                        <div class="member-img">
                            <a href="<?php echo base_url('Dashboard/User/PoolTree/' . $user['user_id']); ?>">
                                <img src="https://dealtaukri.com/SiteAssets/treeimage/<?php echo $user['paid_status'] == 1 ? 'active' : 'inactive';?>.png">
                            </a>
                            <br>
                        ...
                        <ul class="clearfix">
                            ...
                            foreach ($users as $key => $direct) {
                                ...
                                <li>
                                    <div class="member-img">
                                        <a href="<?php echo base_url('Dashboard/User/PoolTree/' . $direct['user_id']); ?>">
                                            <img src="https://dealtaukri.com/SiteAssets/treeimage/<?php echo $direct['paid_status'] == 1 ? 'active' : 'inactive';?>.png">
                                        </a>
                                        <br>
                                    ...
                                    <ul class="clearfix">
                                        ...
                                        foreach ($direct['sub_directs'] as $k => $sub_direct) {
                                            ...
                                            <li>
                                                <div class="member-img">
                                                    <a href="<?php echo base_url('Dashboard/User/PoolTree/' . $sub_direct['user_id']); ?>">
                                                        <img src="https://dealtaukri.com/SiteAssets/treeimage/<?php echo $sub_direct['paid_status'] == 1 ? 'active' : 'inactive';?>.png">
                                                    </a>
