                ...
                <div id="main" class="main">
                    <div class="">
                        ...
                        <div class="row no-gutters">
                            ...
                            <div class="col-xl-3 col-lg-5 col-md-8 col-12 columns m-auto">
                                                ...
                                                <div class="details password-form">
                                                    ...
                                                    <div class="form-group" style="text-align:center;">
                                                     ...
                                                     <div class="form-group text-center account-change ">
                                                        Don't have an account? <a href="<?php echo base_url(); ?>Dashboard/User/Register" class="sign-in-btn">Click Here</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
