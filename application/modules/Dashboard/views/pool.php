                ...
                <ul class="clearfix">
                    <li>
                        <div class="member-img">
                            <a href="">
                                <img src="https://justinlife.in/SiteAssets/treeimage/tree.png">
                            </a>
                        ...
                        <ul class="clearfix">
                            ...
                            foreach ($users as $key => $direct) {
                                ...
                                <li>
                                    <div class="member-img">
                                        <a href="<?php echo base_url('Dashboard/User/Pool/'.$direct['pool_id'])?>">
                                            <img src="https://justinlife.in/SiteAssets/treeimage/tree.png">
                                        </a>
                                        <span><?php echo $direct['user_id']; ?></span><br>
                                        <span><?php echo $direct['user_info']['name']; ?></span><br>
                                        <span><?php echo $direct['pool_id']; ?></span>
                                    </div>
