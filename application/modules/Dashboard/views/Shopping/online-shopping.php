                            ...
                            <div class="mainshopindia">
                                ...
                                <div class="packagesdetsils">
                                    ...
                                    <div class="row text-center">
                                        ...
                                        <input type="number" name="qty" maxlength="10" id="qty" class="input-mini lab-w ng-pristine stk" required="" onkeyup="loadDoc('<?php echo $product['id'];?>')">
                                      </br>
                                    </div>
                                    <div class="row text-center">
                                        <!-- <a class="btn btn-default btn-clear mar-t" href="<?php echo base_url('Dashboard/Shopping/checkout/?quantity[]=1&product_ids[]='.$product['id'].'&user_id='.$user['user_id']);?>">Checkout</a> -->
...
function loadDoc(id){
    // var url = '<?php //echo base_url('Dashboard/Shopping/checkStock/');?>';
    // var qnty = $('.stk').val();
    // console.log(qnty);
    // var product_id = id;
    // $.get(url,{qnty:qnty,product:product_id},function(res){
    //     //console.log(res);
    //     // if(res.stock < res.qnty){
    //     //     alert('not ok');
    //     // }else{
    //     //     alert('ok');
    //     // }
...
$(document).on('click','.addCart',function(){
    ...
    if(quantity > 0){
        ...
        // $.get('<?php //echo base_url('Dashboard/Shopping/checkStock/');?>',{qnty:quantity,product:product_id},function(res){
        //     if(res.stock > res.qnty){
