                                                        ...
                                                        <td colspan="2" align="center">
                                                            <a href="#" class="has-tooltip">
                                                                ...
                                                                <span class="on-hover">
                                                                    ...
                                                                    Package : <?php echo $level1->package_amount;?> Rs.  <br>
                                                                    Sponser ID : <?php echo $level1->sponser_id;?><br>
                                                                    Joining Date : <?php echo $level1->created_at;?><br>
                                                                    Activation Date : <?php echo $level1->topup_date;?><br>
                                                                    Left team : <?php echo $level1->left_count;?> | Right team : <?php echo $level1->right_count;?> <br>
                                                                    Left Active team : <?php echo downlineTeam($level1->user_id,1,'L');?> | Right Active team : <?php echo downlineTeam($level1->user_id,1,'R');?> <br>
                                                                            ...
                                                                            echo'<td id="p1" width="50%" align="center">
                                                                                <a href="'.base_url('Dashboard/User/GenelogyTree/'.$level2[1]->user_id).'" class="has-tooltip">
                                                                                    ...
                                                                                    <span class="on-hover">
                                                                                        ...
                                                                                        Package : '.$level2[1]->package_amount.' Rs. <br>
                                                                                        Sponser ID : '.$level2[1]->sponser_id.'<br>
                                                                                        Joining Date : '.$level2[1]->created_at.'<br>
                                                                                        Activation Date : '.$level2[1]->topup_date.'<br>
                                                                                        Left team : '.$level2[1]->left_count.' | Right team : '.$level2[1]->right_count.' <br>
                                                                                        Left Active team : '.downlineTeam($level2[1]->user_id,1,'L').' | Right Active team : '.downlineTeam($level2[1]->user_id,1,'R').'<br>
                                                                            ...
                                                                            echo'<td id="p1" width="50%" align="center">
                                                                                <a href="'.base_url('Dashboard/User/GenelogyTree/'.$level2[2]->user_id).'" class="has-tooltip">
                                                                                    ...
                                                                                    <span class="on-hover">
                                                                                        ...
                                                                                        Package : '.$level2[2]->package_amount.' Rs.  <br>
                                                                                        Sponser ID : '.$level2[2]->sponser_id.'<br>
                                                                                        Joining Date : '.$level2[2]->created_at.'<br>
                                                                                        Activation Date : '.$level2[2]->topup_date.'<br>
                                                                                        Left team : '.$level2[2]->left_count.' | Right team : '.$level2[2]->right_count.' <br>
                                                                                        Left Active team : '.downlineTeam($level2[2]->user_id,1,'L').' | Right Active team : '.downlineTeam($level2[2]->user_id,1,'R').'<br>
                                                                            ...
                                                                            echo'<td id="p3" width="25%" height="85%" valign="top">
                                                                                <a href="'.base_url('Dashboard/User/GenelogyTree/'.$level3[1]->user_id).'" class="has-tooltip">
                                                                                    ...
                                                                                    <span class="on-hover">
                                                                                        ...
                                                                                        Package : '.$level3[1]->package_amount.' Rs.  <br>
                                                                                        Sponser ID : '.$level3[1]->sponser_id.'<br>
                                                                                        Joining Date : '.$level3[1]->created_at.'<br>
                                                                                        Activation Date : '.$level3[1]->topup_date.'<br>
                                                                                        Left team : '.$level3[1]->left_count.' | Right team : '.$level3[1]->right_count.' <br>
                                                                                        Left Active team : '.downlineTeam($level3[1]->user_id,1,'L').' | Right Active team : '.downlineTeam($level3[1]->user_id,1,'R').'<br>
                                                                            ...
                                                                            echo'<td id="p3" width="25%" height="85%" valign="top">
                                                                                    <a href="'.base_url('Dashboard/User/GenelogyTree/'.$level3[2]->user_id).'" class="has-tooltip">
                                                                                        ...
                                                                                        <span class="on-hover">
                                                                                            ...
                                                                                            Package : '.$level3[2]->package_amount.' Rs.  <br>
                                                                                            Sponser ID : '.$level3[2]->sponser_id.'<br>
                                                                                            Joining Date : '.$level3[2]->created_at.'<br>
                                                                                        Activation Date : '.$level3[2]->topup_date.'<br>
                                                                                            Left team : '.$level3[2]->left_count.' | Right team : '.$level3[2]->right_count.' <br>
                                                                                            Left Active team : '.downlineTeam($level3[2]->user_id,1,'L').' | Right Active team : '.downlineTeam($level3[2]->user_id,1,'R').'<br>
                                                                            ...
                                                                            echo'<td id="p3" width="25%" height="85%" valign="top">
                                                                                    <a href="'.base_url('Dashboard/User/GenelogyTree/'.$level3[3]->user_id).'" class="has-tooltip">
                                                                                        ...
                                                                                        <span class="on-hover">
                                                                                            ...
                                                                                            Package : '.$level3[3]->package_amount.' Rs.  <br>
                                                                                            Sponser ID : '.$level3[3]->sponser_id.'<br>
                                                                                            Joining Date : '.$level3[3]->created_at.'<br>
                                                                                        Activation Date : '.$level3[3]->topup_date.'<br>
                                                                                            Left team : '.$level3[3]->left_count.' | Right team : '.$level3[3]->right_count.' <br>
                                                                                            Left Active team : '.downlineTeam($level3[3]->user_id,1,'L').' | Right Active team : '.downlineTeam($level3[3]->user_id,1,'R').'<br>
                                                                            ...
                                                                            echo'<td id="p3" width="25%" height="85%" valign="top">
                                                                                    <a href="'.base_url('Dashboard/User/GenelogyTree/'.$level3[4]->user_id).'" class="has-tooltip">
                                                                                        ...
                                                                                        <span class="on-hover">
                                                                                            ...
                                                                                            Package : '.$level3[4]->package_amount.' Rs.  <br>
                                                                                            Sponser ID : '.$level3[4]->sponser_id.'<br>
                                                                                            Joining Date : '.$level3[4]->created_at.'<br>
                                                                                            Activation Date : '.$level3[4]->topup_date.'<br>
                                                                                            Left team : '.$level3[4]->left_count.' | Right team : '.$level3[4]->right_count.' <br>
                                                                                            Left Active team : '.downlineTeam($level3[4]->user_id,1,'L').' | Right Active team : '.downlineTeam($level3[4]->user_id,1,'R').'<br>
                                                                                            ...
                                                                                            echo'<td id="p3" width="25%" height="85%" valign="top">
                                                                                                    <a href="'.base_url('Dashboard/User/GenelogyTree/'.$level4[1]->user_id).'" class="has-tooltip">
                                                                                                        ...
                                                                                                        <span class="on-hover">
                                                                                                            ...
                                                                                                            Left Active team : '.downlineTeam($level4[1]->user_id,1,'L').' | Right Active team : '.downlineTeam($level4[1]->user_id,1,'R').'<br>
                                                                                            ...
                                                                                            echo'<td id="p3" width="25%" height="85%" valign="top">
                                                                                                    <a href="'.base_url('Dashboard/User/GenelogyTree/'.$level4[2]->user_id).'" class="has-tooltip">
                                                                                                        ...
                                                                                                        <span class="on-hover">
                                                                                                            ...
                                                                                                            Left Active team : '.downlineTeam($level4[2]->user_id,1,'L').' | Right Active team : '.downlineTeam($level4[2]->user_id,1,'R').'<br>
                                                                                            ...
                                                                                            echo'<td id="p3" width="25%" height="85%" valign="top">
                                                                                                    <a href="'.base_url('Dashboard/User/GenelogyTree/'.$level4[3]->user_id).'" class="has-tooltip">
                                                                                                        ...
                                                                                                        <span class="on-hover">
                                                                                                            ...
                                                                                                            Left Active team : '.downlineTeam($level4[3]->user_id,1,'L').' | Right Active team : '.downlineTeam($level4[3]->user_id,1,'R').'<br>
                                                                                            ...
                                                                                            echo'<td id="p3" width="25%" height="85%" valign="top">
                                                                                                    <a href="'.base_url('Dashboard/User/GenelogyTree/'.$level4[4]->user_id).'" class="has-tooltip">
                                                                                                        ...
                                                                                                        <span class="on-hover">
                                                                                                            ...
                                                                                                            Left Active team : '.downlineTeam($level4[4]->user_id,1,'L').' | Right Active team : '.downlineTeam($level4[4]->user_id,1,'R').'<br>
                                                                                            ...
                                                                                            echo'<td id="p3" width="25%" height="85%" valign="top">
                                                                                                    <a href="'.base_url('Dashboard/User/GenelogyTree/'.$level4[5]->user_id).'" class="has-tooltip">
                                                                                                        ...
                                                                                                        <span class="on-hover">
                                                                                                            ...
                                                                                                            Left Active team : '.downlineTeam($level4[5]->user_id,1,'L').' | Right Active team : '.downlineTeam($level4[5]->user_id,1,'R').'<br>
                                                                                            ...
                                                                                            echo'<td id="p3" width="25%" height="85%" valign="top">
                                                                                                <a href="'.base_url('Dashboard/User/GenelogyTree/'.$level4[6]->user_id).'" class="has-tooltip">
                                                                                                        ...
                                                                                                        <span class="on-hover">
                                                                                                            ...
                                                                                                            Left Active team : '.downlineTeam($level4[6]->user_id,1,'L').' | Right Active team : '.downlineTeam($level4[6]->user_id,1,'R').'<br>
                                                                                            ...
                                                                                            echo'<td id="p3" width="25%" height="85%" valign="top">
                                                                                                    <a href="'.base_url('Dashboard/User/GenelogyTree/'.$level4[7]->user_id).'" class="has-tooltip">
                                                                                                        ...
                                                                                                        <span class="on-hover">
                                                                                                            ...
                                                                                                            Left Active team : '.downlineTeam($level4[7]->user_id,1,'L').' | Right Active team : '.downlineTeam($level4[7]->user_id,1,'R').'<br>
                                                                                            ...
                                                                                            echo'<td id="p3" width="25%" height="85%" valign="top">
                                                                                                    <a href="'.base_url('Dashboard/User/GenelogyTree/'.$level4[8]->user_id).'" class="has-tooltip">
                                                                                                        ...
                                                                                                        <span class="on-hover">
                                                                                                            ...
                                                                                                            Left Active team : '.downlineTeam($level4[8]->user_id,1,'L').' | Right Active team : '.downlineTeam($level4[8]->user_id,1,'R').'<br>
