                    ...
                    <?php echo form_open();?>
                        ...
                        <div class="form-group">
                            ...
                            <select name="income_type" class="form-control">
                              <option value="matching_bonus">Matching Income</option>
                              <option value="silver_income">Silver Income</option>
                              <option value="direct_level_income">Direct Level Income</option>
                              <option value="gold_income">Gold Income</option>
                              <option value="platinum_income">Platinum Income</option>
                              <option value="upline_income">Upline Income</option>
                              <option value="club_income">Club Income</option>
                              <option value="repurchase_level_income">Repurchase Level Income</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label>Type</label>
