...
<html dir="ltr" lang="en">
    ...
    <body>
        ...
        <div class="midpart p-t-b-95">
            <section class="" style="background:url(https://www.bigdataforhumans.com/media/1164/gdpr_success-1.jpeg); background-size:cover; padding:40px 0px">
                                ...
                                <div style="background: #fff;border-radius: 20px;text-align: center;display: table;margin: 0px auto;max-width: 600px;padding-top: 20px;padding: 20px 20px;margin-bottom: 40px; margin-top:10px;   -webkit-box-shadow: -1px 2px 17px -2px rgba(0,0,0,0.75);
                                    ...
                                    <div id="CPH1_Up1">
                                        <div id="CPH1_updProgress" style="display:block;">
                                            <div class="ProgressBg" style="background: #d86c6c;">
                                                <center>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="ending-text">
                                <p>
                                    <small>© 2020 <?php echo title;?> Marketing Private Limited | All rights reserved
                                    </small>
                                </p>
                            </div>
                        </div>
