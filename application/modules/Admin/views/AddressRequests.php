                    ...
                    <tbody>
                        ...
                        foreach ($users as $key => $user) {
                            ...
                            <tr>
                                ...
                                <td><img src="<?php echo base_url('uploads/'.$user['id_proof']); ?>" data-image="<?php echo base_url('uploads/'.$user['id_proof']); ?>" style="cursor:pointer;" width="50px" class="img-responsive zmimg"></td>
                                <td><img src="<?php echo base_url('uploads/'.$user['id_proof2']); ?>" data-image="<?php echo base_url('uploads/'.$user['id_proof2']); ?>" style="cursor:pointer;" width="50px" class="img-responsive zmimg"></td>
                                <td><img src="<?php echo base_url('uploads/'.$user['id_proof3']); ?>" data-image="<?php echo base_url('uploads/'.$user['id_proof3']); ?>" style="cursor:pointer;" width="50px" class="img-responsive zmimg"></td>
                                <td><img src="<?php echo base_url('uploads/'.$user['id_proof4']); ?>" data-image="<?php echo base_url('uploads/'.$user['id_proof4']); ?>" style="cursor:pointer;" width="50px" class="img-responsive zmimg"></td>
                                <td>
                                    <?php
